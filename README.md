...
### Machine Learning
1. Insert the low.pkl, medium.pkl, high.pkl files into the path of Machine_Learning/ensemble/models/ from ML_3models folder in dataset
2. You can set the terminal path to '.../Machine_Learning/' and execute it.
### Deep Learning
